...
import { getMockTestDetails, startMockTest } from '../../services/mocktestAPI';
// import { getQuestionDetails } from '../../services/practiceAPI';
import { saveAnswer, initiateAnswer } from '../../services/mocktestAPI';
...
import { clearAudioCache, preloadAudios } from '@/app/services/downloadAPI';
...
const MockTestPage = () => {
  ...
  const handleShowDialog = async (data: any) => {
    const confirmed = await showDialog('mock', {
      title: 'Result',
      content: data,
    });
